    ...
    <div class="relative flex items-center">
        ...
        <div class="absolute left-4 flex items-center space-x-1 sm:space-x-2">
            ...
            <div class="relative group">
                ...
                <div
                    class="absolute bottom-10 z-10 left-1/2 -translate-x-1/2 mt-2 w-72 p-4 bg-black text-white text-sm rounded-lg shadow-lg opacity-0 group-hover:opacity-100 transition duration-200 pointer-events-none">
        ...
        <div class="absolute right-4 flex items-center space-x-1 sm:space-x-2">
            <!-- <div class="relative" id="model-select-container">
                ...
                <div id="model-dropdown"
                    class="absolute right-0 mt-2 w-72 ring-1 ring-black/5 bg-white rounded-lg shadow-lg z-30 hidden">
                    <div class="p-3">
            ...
            <div class="relative">
                ...
                <div id="source-dropdown"
                    class="absolute bottom-10 right-0 mt-2 w-56 ring-1 ring-black/5 bg-white rounded-lg shadow-lg z-30 hidden">
